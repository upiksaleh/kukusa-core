...
class ModelRepoRestUrlRule extends CompositeUrlRule
{
    public $tokens = [
        '{id}' => '<id:\w[a-zA-Z0-9._+-]+>',
...
//        '{module}/{model}/{customAction}' => '<'.ModelRepo::CUSTOM_ACTION_KEY.'>',
    ...
    protected function createRule($pattern, $action)
    {
        ...
        $pattern = Kukusa::$app->modelRepo->prefixUriApi . '/' . $pattern;
    ...
    public function parseRequest($manager, $request)
    {
        ...
        if (strpos($pathInfo, Kukusa::$app->modelRepo->prefixUriApi) !== false) {
