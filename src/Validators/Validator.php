...
class Validator extends Component
{
    ...
    public static $builtInValidators = [
        ...
        'default' => 'Kukusa\Validators\DefaultValueValidator',
        ...
        'required' => 'Kukusa\Validators\RequiredValidator',
        'safe' => 'yii\validators\SafeValidator',
        'string' => 'Kukusa\Validators\StringValidator',
        'trim' => [
     ...
     *
     */
    public function validatorID()
    {
        $classId = explode('\\', static::class);
        return strtolower(str_replace('Validator', '',array_pop($classId)));
    }
    protected $fieldType = 'string';

    public function getRuleConfig($model, $attribute)
    {
